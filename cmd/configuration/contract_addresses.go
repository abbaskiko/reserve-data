...
var defaultAddressConfiguration = map[deployment.Deployment]common.ContractAddressConfiguration{
	deployment.Development: {
		...
		Proxy:   ethereum.HexToAddress("0x818E6FECD516Ecc3849DAf6845e3EC868087B755"),
	},
	deployment.Staging: {
		...
		Proxy:   ethereum.HexToAddress("0xC14f34233071543E979F6A79AA272b0AB1B4947D"),
	},
	...
	deployment.Ropsten: {
		...
		Proxy:   ethereum.HexToAddress("0x0a56d8a49E71da8d7F9C65F95063dB48A3C9560B"),
	},
}
...
func NewContractAddressConfigurationFromContext(c *cli.Context) (*common.ContractAddressConfiguration, error) {
	...
	if len(reserveContractStr) != 0 && len(wrapperContractStr) != 0 && len(pricingContractStr) != 0 {
		...
		conf.Proxy = ethereum.HexToAddress(networkContractStr)
		return conf, nil
	}
