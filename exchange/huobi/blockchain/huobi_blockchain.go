...
func (b *Blockchain) SendTokenFromAccountToExchange(amount *big.Int, exchangeAddress, tokenAddress ethereum.Address, gasPrice *big.Int) (*types.Transaction, error) {
